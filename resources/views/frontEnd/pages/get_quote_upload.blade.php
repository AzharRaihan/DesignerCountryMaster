...
<section id="file_upload_message">
    <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5">
        <div class="row">
            <div class="col-md-10 offset-md-1 pt-col-2 pt-sm-3 pt-md-4 pt-lg-5 pt-xl-5 mobile-pt">
                <div class="mobile-py mobile-pt">
...
<section id="file_upload_body">
    <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5 mobile-py">

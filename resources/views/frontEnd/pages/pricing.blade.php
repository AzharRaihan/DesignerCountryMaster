      ...
      <div class="row" style="justify-content: center !important;">
        <div class="column clipping_path">
          <div class="content">
            ...
            <img src="{{asset('assets/frontEnd/images/pricing/Clipping-Path.png')}}" alt="Mountains" style="width:100%">
          </div>
        </div>
        <div class="column background_removal">
          <div class="content">
            <div class="div text-center">
              <p class="text-light py-2">Background Removal<span class="pl-3" style="letter-spacing: 2px;"><b>$0.39</b>
                  </span< /p>
            </div> <img src="{{asset('assets/frontEnd/images/pricing/Background-removal.png')}}" alt="Mountains"
              style="width:100%">
          </div>
        </div>
        <div class="column image_masking">
          <div class="content">
            ...
            <img src="{{asset('assets/frontEnd/images/pricing/Image-masking.png')}}" alt="Mountains" style="width:100%">
          </div>
        </div>
        ...
        <div class="column drop_shadow">
          <div class="content">
            <div class="div text-center">
              <p class="text-light py-2">Drop Shodow<span class="pl-3" style="letter-spacing: 2px;"><b>$0.49</b></span>
              </p>
            </div>
            <img src="{{asset('assets/frontEnd/images/pricing/Drop-shadow.png')}}" alt="Mountains" style="width:100%">
          </div>
        </div>
        ...
        <div class="column multi_clipping">
          <div class="content">
            ...
            <img src="{{asset('assets/frontEnd/images/pricing/Product-photo-editing.png')}}" alt="Mountains"
              style="width:100%">
          </div>
        </div>
...
<section id="pricing_body">
  <div class="container py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5">
    ...
    <div class="row py-col-2 py-sm-3 py-md-4 py-lg-5 py-xl-5">
      <div class="col-md-4">
        <ul class="list-group mb-3 text-center"
          style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
          <li class="list-group-item py-col-2 py-sm-3 py-md-3 py-lg-4 py-xl-4" style="background-color: #023441;">
      ...
      <div class="col-md-4">
        <ul class="list-group mb-3 text-center"
          ...
          <li class="list-group-item" style="background-color: #023441;">
            <a class="text-light" href="{{route('get.quote')}}"><b>ORDER NOW</b></a>
          </li>
        </ul>
      </div>
    ...
    <p class="text-center mobile-pr mobile-pl">We have a big discount for bulk photo processing, you first get discount
      for editing
